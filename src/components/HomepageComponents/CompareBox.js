...
const CompareBox = () => {
  ...
  return (
    <div className='compare-box-element'>
        <h3 className='compare-box-contianer-title title'>Compare all inclusive student homes.</h3>
        <div className='compare-box-container'>
          <div className='compare-box'>
            ...
            <p className='compare-box-title title'>Search</p>
            <p className='comapre-box-description description'>
          ...
          <div className='compare-box'>
            ...
            <p className='compare-box-title title'>Compare</p>
            <p className='comapre-box-description description'>
          ...
          <div className='compare-box'>
            ...
            <p className='compare-box-title title'>Bills Included</p>
            <p className='comapre-box-description description'>
